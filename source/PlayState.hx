...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Get Real!', 0.2], //From 0% to 19%
		['Balls', 0.4], //From 20% to 39%
		['You fuckin' Suck', 0.5], //From 40% to 49%
		['I miss my wife tails.', 0.6], //From 50% to 59%
		['You have sinned', 0.69], //From 60% to 68%
		['69 Nice', 0.7], //69%
		['Balls In Your Jaw', 0.8], //From 70% to 79%
		['Good', 0.9], //From 80% to 89%
		['Great!', 1], //From 90% to 99%
		['Bruh', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
